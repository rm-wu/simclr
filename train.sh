...
python train.py --use_wandb --natural_augmentation --num_workers 8 --devices=1 --backbone=resnet18 --batch_size_per_device=128  --max_epochs=10 --data_dir=/mnt/qb/work/bethge/cyildiz40/simclr/PetFace --seed=42 
