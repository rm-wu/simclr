...
img_sizes = [512, 512, 512, 512, 504, 504]
patch_sizes = [16, 16, 16, 16, 14, 14]
seed = 42
...
data_path = Path("/flash/project_462000585/mereuric/data/ADEChallengeData2016")

jobs_path = project_path / "jobs" / "linear_seg" / dataset_name
...
#SBATCH --output={logs_path}/{model_name}_{dataset_name}_{img_size}_{patch_size}_{emb_size}_{seed}_%j.out   
#SBATCH --error={logs_path}/{model_name}_{dataset_name}_{img_size}_{patch_size}_{emb_size}_{seed}_%j.err     
...
with open("submit_jobs_linseg.sh", "w") as f:
