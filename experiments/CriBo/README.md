...
```
```bash
torchrun --nproc_per_node=2 --nnodes=1 main_cribo.py --imagenet1k_path=/home/mereur1/projects/ocl/data/imagenet --output_dir . --n_tokens=32 --queue_size=25000 --pos_alpha 1.0 1.0 --arch vit_small --batch_size_per_gpu=64
```
