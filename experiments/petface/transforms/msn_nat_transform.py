...
class MSNNaturalTransform(MSNTransform):
    ...
    def __init__(
        ...
        apply_focal_transforms_to_both: bool = False,
    ):
        super().__init__(
            ...
            focal_crop_scale=focal_crop_scale,
            cj_prob=cj_prob,
        ...
        self.apply_focal_transforms_to_both = apply_focal_transforms_to_both
    ...
    def __call__(self, images: Union[List[Tensor], List[Image]]) -> Union[List[Tensor], List[Image]]:
        ...
        views = [
            self.transforms[0](images[0]),
            self.transforms[1](images[1])
        ]

        if self.apply_focal_transforms_to_both:
