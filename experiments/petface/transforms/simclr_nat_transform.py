...
class SimCLRNaturalTransform(SimCLRTransform):
    """Extends the transformations for SimCLR [0, 1] to work with natural augmentations.
    ...
    def __call__(self, images: Union[List[Tensor], List[Image]]) -> Union[List[Tensor], List[Image]]:
        return [self.transforms[0](images[0]), self.transforms[1](images[1])] 