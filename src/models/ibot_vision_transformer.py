...
def get_ibot_model_by_name(model_name):
    # ViT-B/16
    def bar_progress(current, total, width=80):
        ...
        sys.stdout.flush()
    model_paths = {
        "ibot_vits16": "https://lf3-nlp-opensource.bytetos.com/obj/nlp-opensource/archive/2022/ibot/vits_16/checkpoint_teacher.pth",
        "ibot_vitb16": "https://lf3-nlp-opensource.bytetos.com/obj/nlp-opensource/archive/2022/ibot/vitb_16/checkpoint_teacher.pth",
        "ibot_vitl16": "https://lf3-nlp-opensource.bytetos.com/obj/nlp-opensource/archive/2022/ibot/vitl_16/checkpoint_teacher.pth",
    }
    ...
    if model_name == "ibot_vits16":
        vit = vit_small(patch_size=16, return_all_tokens=True)
    elif model_name == "ibot_vitb16":
        vit = vit_base(patch_size=16, return_all_tokens=True)
    elif model_name == "ibot_vitl16":
        vit = vit_large(patch_size=16, return_all_tokens=True)
    else:
